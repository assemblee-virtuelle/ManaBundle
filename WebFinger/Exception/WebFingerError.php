...
namespace AssembleeVirtuelle\ManaBundle\WebFinger\Exception;

/**
 * Exception that's thrown when something is not supported
 *
 */
class WebFingerError extends \Exception
{
  /**
